...
public class Solution {
    public void safeMethod(Object obj1, Object obj2) {
        ...
        String j = obj2.toString();

        Object tmpObj1 = i.compareTo(j) > 0 ? obj1 : obj2;
        Object tmpObj2 = i.compareTo(j) > 0 ? obj2 : obj1;
        synchronized (tmpObj1) {
            longTimeMethod();
            synchronized (tmpObj2) {
                unsafeMethod(tmpObj1, tmpObj2);
            }
        }
    }
